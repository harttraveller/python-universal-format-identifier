...
class Resolve:
    @staticmethod
    def loc(loc: Union[str, Path], val: bool) -> ResolutionResult:
        if "." in loc:
    ...
    @staticmethod
    def uri(uri: str) -> ResolutionResult:
        # check if actually uri
        pass

    @staticmethod
    def raw(raw: str) -> ResolutionResult:
        pass
